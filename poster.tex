...
\paragraph{Total cost} A walk in the isogeny graph is 880$s$, approx. 12$s$ spent with each prime $\ell$ up to 907. We can do better if the initial curve has more Elkies primes.
}
